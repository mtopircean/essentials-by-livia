...
#AddProductResource: Defines a resource for handling import and export operations
...
#AddPromotionResource: Defines a resource for handling import and export operations
#for the AddPromotion model. It extends ModelResource from django-import-export.
class AddPromotionResource(resources.ModelResource):
    class Meta:
        model = AddPromotion

#AppUserResource: Defines a resource for handling import and export operations
#for the AppUser model. It extends ModelResource from django-import-export.
class AppUserResource(resources.ModelResource):
    class Meta:
        model = AppUser
        
#AddAilmentResource: Defines a resource for handling import and export operations
